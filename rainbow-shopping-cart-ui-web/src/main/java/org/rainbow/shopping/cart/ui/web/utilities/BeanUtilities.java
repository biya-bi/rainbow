...
public class BeanUtilities {
     ...
     * @param defaultValue A default value to be returned if either a) The
     * property is not found or b) if the property is found but the value is
     * null
     ...
     * @param obj The object who's property you want to fetch
     * @param property The property name
     * @param getterPrefix The prefix of the getter method.
	...
	public static Object getProperty(Object obj, String property, String getterPrefix) {
        ...
        try {
            String methodName = getterPrefix + property.substring(0, 1).toUpperCase() + property.substring(1, property.length());
