USE `rainbow_security`;

start transaction;
set @applicationId=(select ifnull(max(id),0)+1 from applications);
set @applicationName='Coronation Stock Management';
set @applicationDescription='Application for managing Coronation Merchant Bank''s stock';
...
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+5,'ROLE_READ_EMAIL_RECIPIENTS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+6,'ROLE_WRITE_EMAIL_RECIPIENTS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+7,'ROLE_READ_EMAIL_TEMPLATES','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+8,'ROLE_WRITE_EMAIL_TEMPLATES','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+9,'ROLE_READ_LOCALES','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+10,'ROLE_WRITE_LOCALES','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+11,'ROLE_READ_LOCATIONS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+12,'ROLE_WRITE_LOCATIONS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+13,'ROLE_READ_MANUFACTURERS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+14,'ROLE_WRITE_MANUFACTURERS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+15,'ROLE_READ_PRODUCT_ISSUES','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+16,'ROLE_WRITE_PRODUCT_ISSUES','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+17,'ROLE_READ_PRODUCT_RECEIPTS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+18,'ROLE_WRITE_PRODUCT_RECEIPTS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+19,'ROLE_READ_PRODUCTS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+20,'ROLE_WRITE_PRODUCTS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+21,'ROLE_READ_PURCHASE_ORDERS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+22,'ROLE_WRITE_PURCHASE_ORDERS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+23,'ROLE_READ_SHIP_METHODS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+24,'ROLE_WRITE_SHIP_METHODS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+25,'ROLE_READ_SHIPPING_ORDERS','',@applicationId,current_timestamp(),current_timestamp(),1);
insert into authorities(ID,NAME,DESCRIPTION,APPLICATION_ID,creation_date,last_update_date,version) VALUES (@authorityId+26,'ROLE_WRITE_SHIPPING_ORDERS','',@applicationId,current_timestamp(),current_timestamp(),1);
