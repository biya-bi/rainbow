 ...
 * @author Biya-Bi
 */
@DatabaseInitialize("src/test/resources/PurchaseOrderServiceTestSetup.sql")
public class PurchaseOrderServiceTest extends AbstractServiceTest {
	...
	@Test(expected = PurchaseOrderVendorException.class)
	public void update_VendorInactiveExist_ThrowPurchaseOrderVendorException() throws Exception {
