 ...
 * @author Biya-Bi
 */
@DatabaseInitialize("src/test/resources/ProductReceiptServiceTestSetup.sql")
public class ProductReceiptServiceTest extends AbstractServiceTest {
	...
	@Test
	public void create_ProductReceiptIsValid_itemReceiptCreated() throws Exception {
	...
	public void update_PreviouselyReceivedQuantityIsUsedUpAndNewQuantityIsGreaterThanOldQuantity_NewQuantityMinusOldQuantityAddedToInventory()
		...
		for (ProductReceiptDetail detail : details) {
			...
			if (detail.getId().getDetailId() == 3 && detail.getProduct().getId().equals(11003L)) {
	...
	@Test
	public void delete_ProductReceiptExists_itemReceiptDeletedAndLocationInventoryAdjusted() throws Exception {
