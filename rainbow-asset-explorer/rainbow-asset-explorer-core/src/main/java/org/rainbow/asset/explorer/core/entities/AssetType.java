...
import org.rainbow.asset.explorer.core.audit.AssetTypeAudit;
...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AssetType.findAll", query = "SELECT at FROM AssetType at"),
...
public class AssetType extends Trackable<Long> {
    ...
    public String toString() {
        return "org.rainbow.asset.explorer.core.entities.AssetType[ id=" + getId() + " ]";
    }
}
