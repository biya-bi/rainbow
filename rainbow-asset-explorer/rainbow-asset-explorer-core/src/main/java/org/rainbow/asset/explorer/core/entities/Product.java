...
import org.rainbow.asset.explorer.core.audit.ProductAudit;
...
@Auditable(audit = ProductAudit.class)
public class Product extends Trackable<Long> {
    ...
    public Product(String number, String name, Short safetyStockLevel, Short reorderPoint, Short stockCover, String description, Date creationDate, Date lastUpdateDate) {
    ...
    public Product(String number, String name, Short safetyStockLevel, Short reorderPoint, Short stockCover, String description, Date creationDate, Date lastUpdateDate, long version, Long id) {
    ...
    public String toString() {
        return "org.rainbow.asset.explorer.core.entities.Product[ id=" + getId() + " ]";
    }
}
