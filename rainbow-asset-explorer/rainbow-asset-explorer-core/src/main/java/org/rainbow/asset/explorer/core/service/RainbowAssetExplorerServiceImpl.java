...
import org.rainbow.asset.explorer.core.utilities.TransactionSettings;
...
public class RainbowAssetExplorerServiceImpl<TEntity, TKey extends Serializable, TSearchOptions>
		implements Service<TEntity, TKey, TSearchOptions> {
	private Dao<TEntity, TKey, TSearchOptions> dao;

	public RainbowAssetExplorerServiceImpl(Dao<TEntity, TKey, TSearchOptions> dao) {
		if (dao == null)
