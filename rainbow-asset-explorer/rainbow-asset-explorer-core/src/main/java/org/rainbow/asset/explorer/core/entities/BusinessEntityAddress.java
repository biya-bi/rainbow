...
import org.rainbow.asset.explorer.core.audit.BusinessEntityAddressAudit;
 ...
 */
@Entity
@Table(name = "BUSINESS_ENTITY_ADDRESS", uniqueConstraints = @UniqueConstraint(columnNames = {"BUSINESS_ENTITY_ID", "ADDRESS_TYPE"}))
...
public class BusinessEntityAddress extends Address {
    ...
    public BusinessEntityAddress(BusinessEntity businessEntity, AddressType addressType, String line1, String line2, Long id) {
    ...
    public String toString() {
        return "org.rainbow.asset.explorer.core.entities.BusinessEntityAddress[ id=" + getId() + " ]";
    }
}
