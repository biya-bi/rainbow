package org.rainbow.asset.explorer.core.utilities;
...
public class EntityManagerHelper {
	...
	public <TEntity> TEntity findById(Class<TEntity> entityClass, Object id) {
		TEntity obj;
		try {
			...
			throw new NonexistentEntityException(String.format("No entity with id '{s}' was found.", id), e);
		}
		return obj;
	}
	 ...
	 *             entity was found.
	 */
	public <TEntity> TEntity find(Class<? extends TEntity> entityClass, TEntity entity) throws NonexistentEntityException {
		try {
