...
import org.rainbow.asset.explorer.core.audit.CurrencyAudit;
...
public class Currency extends Trackable<Integer> {
    ...
    public Currency(String createdBy, String updatedBy, Date creationDate, Date lastUpdateDate, long version, Integer id) {
        super(createdBy, updatedBy, creationDate, lastUpdateDate, version, id);
    }

    public Currency(String name, String description, String createdBy, String updatedBy, Date creationDate, Date lastUpdateDate) {
        super(createdBy, updatedBy, creationDate, lastUpdateDate);
        this.name = name;
        this.description = description;
    }

    public Currency(String name, String description, String createdBy, String updatedBy, Date creationDate, Date lastUpdateDate, long version, Integer id) {
        super(createdBy, updatedBy, creationDate, lastUpdateDate, version, id);
        this.name = name;
        this.description = description;
    }
    ...
    public String toString() {
        return "org.rainbow.asset.explorer.core.entities.Currency[ id=" + getId() + " ]";
    }
}
