...
import org.rainbow.asset.explorer.core.audit.EmailTemplateAudit;
...
public class EmailTemplate extends Trackable<Integer> {
    ...
    public EmailTemplate(String name, String subject, String content, Locale locale, String createdBy, String updatedBy, Date creationDate, Date lastUpdateDate, long version, Integer id) {
    ...
    public String toString() {
        return "org.rainbow.asset.explorer.core.entities.EmailTemplate[ id=" + getId() + " ]";
    }
}
