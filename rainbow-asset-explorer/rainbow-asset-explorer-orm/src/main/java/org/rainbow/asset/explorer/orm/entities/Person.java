...
public abstract class Person extends BusinessEntity {
	...
	public Person(String lastName, String firstName, String middleName, Gender gender, Date birthDate, String title,
			String suffix, boolean nameStyle, Date creationDate, Date lastUpdateDate) {
	...
	public Person(String lastName, String firstName, String middleName, Gender gender, Date birthDate, String title,
			String suffix, boolean nameStyle, Date creationDate, Date lastUpdateDate, long version, Long id) {
