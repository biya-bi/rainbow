...
@Named
@ViewScoped
public class EmailTemplateListController extends AbstractNumericIdAuditableEntityListController<EmailTemplate, Integer> {
	...
	public EmailTemplateListController() {
		super(Integer.class);
