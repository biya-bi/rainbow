...
@Named
@ViewScoped
public class ManufacturerListController extends AbstractNumericIdAuditableEntityListController<Manufacturer, Long> {
	...
	@Override
	protected Service<Manufacturer> getService() {
		return service;
	}
