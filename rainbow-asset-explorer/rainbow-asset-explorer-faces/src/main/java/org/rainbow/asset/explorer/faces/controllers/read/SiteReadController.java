...
@Named
@ViewScoped
public class SiteReadController extends AbstractNumericIdAuditableEntityReadController<Site, Long> {
	...
	@Override
	public Service<Site> getService() {
		return service;
	}
