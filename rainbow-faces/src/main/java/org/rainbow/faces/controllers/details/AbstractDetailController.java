...
import static org.rainbow.faces.controllers.details.ResourceBundles.CRUD_MESSAGES;
import static org.rainbow.faces.controllers.details.ResourceBundles.MESSAGES;
import static org.rainbow.faces.controllers.details.ResourceBundles.SECURITY_MESSAGES;
...
public abstract class AbstractDetailController<TEntity extends AbstractAuditableEntity<?>> implements Serializable {
	...
	public AbstractDetailController(Class<TEntity> modelClass) {
