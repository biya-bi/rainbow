...
import static org.rainbow.journal.ui.web.utilities.ResourceBundles.MESSAGES;
import static org.rainbow.journal.ui.web.utilities.ResourceBundles.SECURITY_MESSAGES;
...
public abstract class Controller<TEntity extends Trackable<TKey>, TKey extends Serializable, TSearchOptions>
	...
	public TEntity prepareCreate() {
		try {
			return this.current = (TEntity) modelClass.getConstructor().newInstance(new Object[] {});
