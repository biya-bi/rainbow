...
public class JdbcUserDetailsService extends JdbcDaoImpl {
	...
	private String passwordExpiredQuery = "SELECT m.LAST_PWD_CHANGE_DATE AS LAST_PWD_CHANGE_DATE,m.CREATION_DATE AS CREATION_DATE,pp.MAXIMUM_PASSWORD_AGE AS MAXIMUM_PASSWORD_AGE, pp.MINIMUM_PASSWORD_AGE "
